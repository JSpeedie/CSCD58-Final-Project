...
int enc_file(char in_name[MAXLINEENC+1], char out_name[MAXLINEENC+1], uint32_t key[4]) {
    FILE *in;
    FILE *fp;
    extern FILE *popen();
    size_t read_len;
...
int dec_file(char in_name[MAXLINEENC+1], char out_name[MAXLINEENC+1], uint32_t key[4]) {
    FILE *in;
    FILE *fp;
    extern FILE *popen();
    size_t read_len;
